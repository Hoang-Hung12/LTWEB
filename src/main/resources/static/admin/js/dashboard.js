// API đã được khai báo trong script.js
...
async function loadDons() {
    try {
        ...
        document.getElementById('kpi-pending').textContent = cho;
        ...
        // Donut chart với đúng 4 trạng thái trong DB
        ...
        tbody.innerHTML = recent.map(d => {
            const ttClass = ttClassMap[d.trangThai] || 'badge-soft-secondary';
