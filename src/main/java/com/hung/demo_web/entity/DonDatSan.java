...
public class DonDatSan {
    ...
    public Boolean getDaXacNhanThanhToan(){ 
        return daXacNhanThanhToan; 
    }
    public void setDaXacNhanThanhToan(Boolean daXacNhanThanhToan){ 
        this.daXacNhanThanhToan = daXacNhanThanhToan; 
    }
